...
public class UMSSQLOutput {
	...
	private static void outCus() {
		File file = new File("f:/ums_user.txt");
		File fileout= new File("f:/ums_user-out.txt");
...
**/
	...
	private static void outShanping() {
		File file = new File("f:/商品资料.csv");
		File fileout= new File("f:/商品资料-out.txt");
	...
	private static void outPro() {
		File file = new File("f:/项目资料.csv");
		File fileout= new File("f:/项目资料-out.txt");
	...
	private static void outUserInfo() {
		File file = new File("f:/员工信息.csv");
		File fileout= new File("f:/员工信息-out.txt");
