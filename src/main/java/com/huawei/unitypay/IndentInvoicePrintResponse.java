 ...
 *         &lt;element name="invoiceLists" type="{http://huawei.com/UnityPay/}InvoiceListType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "indentInvoicePrintResponse")
public class IndentInvoicePrintResponse {
    ...
    @XmlElement(required = true)
    protected List<InvoiceListType> invoiceLists;
     ...
     * 
     */
    public List<InvoiceListType> getInvoiceLists() {
        if (invoiceLists == null) {
            invoiceLists = new ArrayList<InvoiceListType>();
        }
